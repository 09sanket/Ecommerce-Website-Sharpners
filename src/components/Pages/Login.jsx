        ...
        <div className="mt-[30px] flex flex-col items-center " >
            ...
            <div className=" grid sm:grid-cols-2 sm:grid-rows-1 p-7 bg-gradient-to-r from-cyan-600 to-blue-500 ... ">
                ...
                <div className=" hidden sm:block bg-white   ">
                    <img className="object-cover max-h-[400px] w-full " src="https://png.pngtree.com/png-vector/20220801/ourmid/pngtree-login-form-weathered-vintage-password-vector-png-image_8800772.png" alt="" />
