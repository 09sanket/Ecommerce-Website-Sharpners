	...
	return (
		<div className=" flex flex-col justify-between border border-gray-300 max-w-[400px] max-h-[450px] shadow-lg ">
			<div className="flex justify-between    ">
				<div className="bg-green-700 text-white px-2 font-bold">
					SALE
				</div>
			...
			<div className="px-4 pb-1 flex flex-col justify-center items-center ">
				<p className="font-medium font-bold">{props.anime}</p>
				...
				<p className="text-gray-500">
				 ...
				 <NavLink to={`/${props.id}`}
					...
					className="border bg-green-700 text-white p-1 rounded-md hover:bg-red-900 font-bold ">
					View Product
				</NavLink> 
			</div>
		</div>
